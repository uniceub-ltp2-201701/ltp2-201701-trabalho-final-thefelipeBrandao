...
/**
 * Servlet implementation class ServletListaFilmesDeUmaProfissaoDeUmIntegrante
 */
@WebServlet("/listaFilmesDeUmaProfissaoDeUmIntegrante")
public class ServletListaFilmesDeUmaProfissaoDeUmIntegrante extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletListaFilmesDeUmaProfissaoDeUmIntegrante() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/respostaListaFilmesDeUmaProfissaoDeUmIntegrante.jsp");
