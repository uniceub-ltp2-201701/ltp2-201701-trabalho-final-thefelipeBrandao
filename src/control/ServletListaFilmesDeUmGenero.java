...
/**
 * Servlet implementation class ServletListaFilmesDeUmGenero
 */
@WebServlet("/listaFilmesDeUmGenero")
public class ServletListaFilmesDeUmGenero extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletListaFilmesDeUmGenero() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("respostaListaFilmesDeUmGenero.jsp");
