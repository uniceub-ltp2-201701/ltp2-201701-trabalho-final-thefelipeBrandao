...
/**
 * Servlet implementation class ServletListaIntegrantesDeUmGenero
 */
@WebServlet("/listaIntegrantesDeUmGenero")
public class ServletListaIntegrantesDeUmGenero extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletListaIntegrantesDeUmGenero() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("respostaListaIntegrantesDeUmGenero.jsp");
