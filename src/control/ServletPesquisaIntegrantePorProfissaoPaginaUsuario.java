...
/**
 * Servlet implementation class ServletPesquisaIntegrantePorProfissaoPaginaUsuario
 */
@WebServlet("/pesquisaIntegrantePorProfissaoPaginaUsuario")
public class ServletPesquisaIntegrantePorProfissaoPaginaUsuario extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ServletPesquisaIntegrantePorProfissaoPaginaUsuario() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/respostaPesquisaIntegrantePorProfissaoPaginaUsuario.jsp");
